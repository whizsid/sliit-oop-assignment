            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <button type="submit" class="btn btn-danger"><i class="fa fa-ban"></i> <span>Delete</span></button>						
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            <td>
                                <span class="custom-checkbox">
                                    <input type="checkbox" id="checkbox${loop.index}" class="checkbox" name="delete" value="${user.getId()}">
